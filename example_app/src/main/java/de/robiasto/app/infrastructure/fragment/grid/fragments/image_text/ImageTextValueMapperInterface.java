 ...
 **/
public interface ImageTextValueMapperInterface {
    List<ImageTextFragment> getFragments(FieldDtoInterface fieldDto);
    ImageTextFragment getFragment(FieldDtoInterface fieldDto);
}
