 ...
 */
public abstract class AbstractLocalFragment implements CssClassFragmentInterface, FragmentInterface, SetFragmentPathInterface {
    @Getter
    ...
    protected AbstractLocalFragment() {
        this.fragmentFunction = this.getClass().getSimpleName();
        this.fragmentPath = "fragments/"
    ...
    public void setPath(String fragmentPath, String fragmentFunction) {
        this.fragmentPath = fragmentPath;
        this.fragmentFunction = fragmentFunction;
    }

    public String getPath() {
        return this.fragmentPath + " :: " + this.fragmentFunction;
    }
